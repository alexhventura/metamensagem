...
import { computeLayoutZones, type LayoutZones, type ZoneDensity, resolveFooterFormatProfile } from './safeZone.js';
...
export { resolveFooterFormatProfile } from './safeZone.js';
