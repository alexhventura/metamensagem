  ...
  pt: {
    translation: {
      ...
      "translate_page": {
        ...
        "button_short": "Ler no meu idioma",
        ...
        "hint_phrase": "Esta frase está em {{source}}.",
        "hint_cta": "Traduzir para {{target}}?",
        "title": "Traduzir página inteira",
        "body": "Escolha um idioma para traduzir frase, explicação, tags, menus e navegação.",
  ...
  en: {
    translation: {
      ...
      "translate_page": {
        ...
        "button_short": "Read in my language",
        ...
        "hint_phrase": "This quote is in {{source}}.",
        "hint_cta": "Translate to {{target}}?",
        "title": "Translate the whole page",
        "body": "Choose a language to translate the quote, explanation, tags, menus, and navigation.",
