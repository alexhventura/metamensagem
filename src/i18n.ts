  ...
  pt: {
    translation: {
      ...
      "translate_page": {
        ...
        "card_sync_body": "A tradução vale para a página inteira — frases, metáforas, menus e navegação — não só este card.",
  ...
  en: {
    translation: {
      ...
      "translate_page": {
        ...
        "card_sync_body": "Translation applies to the whole page — quotes, metaphors, menus and navigation — not just this card.",
  ...
  es: {
    translation: {
      ...
      "translate_page": {
        ...
        "button_short": "Traducir página",
        "read_in_my_language": "Leer en mi idioma",
        "button_active": "Idioma: {{lang}}. Cambiar traducción.",
        "modal_title": "Traducir página",
        "modal_subtitle": "Elige el idioma deseado.",
        "modal_note": "La traducción se aplicará a toda la página.",
        "card_sync_body": "La traducción vale para toda la página — frases, metáforas, menús y navegación — no solo esta tarjeta.",
  ...
  fr: {
    translation: {
      ...
      "translate_page": {
        ...
        "button_short": "Traduire la page",
        "read_in_my_language": "Lire dans ma langue",
        "button_active": "Langue : {{lang}}. Modifier la traduction.",
        "modal_title": "Traduire la page",
        "modal_subtitle": "Choisissez la langue souhaitée.",
        "modal_note": "La traduction s’applique à toute la page.",
        "card_sync_body": "La traduction s’applique à toute la page — citations, métaphores, menus et navigation — pas seulement cette carte.",
